...
tdl = [["Name:","Age:","Birth Year:","Gender:","Race:","Birthplace:","Marital Status:","Relation to Head of House:","Home in 1910:","Immigration Year:","Household Members:"]]
...
def process_data(page, record):
    ...
    with open(path.join(path.join("pages","round" + str(page) + "page" + str(record) + ".html"))) as html: #Open the html file for processing
        ...
        working_list[YEAR_BOX] = findput("Birth",soup)
        ...
        working_list[HOME_BOX] = findput("Home in 1910:", soup)
...
def main():
    ...
    while path.exists(path.join("pages","round" + str(current_page) + "page" + str(current_record) + ".html")): #Once all the pages are downloaded,
        ...
        if current_record != 19:
            ...
            current_record = 0
    sheet = pe.Sheet(tdl)
    sheet.save_as("1910censusrecords.csv")
