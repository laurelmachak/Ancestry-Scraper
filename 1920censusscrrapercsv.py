...
tdl = [["Name:","Age:","Birth Year:","Gender:","Race:","Birthplace:","Marital Status:","Relation to Head of House:","Home in 1920:","Immigration Year:","Street:","House Number:","Occupation:","Industry:","Employment Field:","Native Tongue:","Naturalization Status:","Household Members:"]]
...
def process_data(page, record):
    ...
    with open(path.join(path.join("pages","round" + str(page) + "page" + str(record) + ".html"))) as html: #Open the html file for processing
        ...
        working_list[HOME_BOX] = findput("Home in 1920:", soup)
        ...
        working_list[CLASS_BOX] = findput("Field",soup)
        working_list[NATTON_BOX] = findput("Native",soup)
        working_list[NATU_BOX] = findput("Naturalization",soup)
...
def main():
    ...
    while path.exists(path.join("pages","round" + str(current_page) + "page" + str(current_record) + ".html")): #Once all the pages are downloaded,
        ...
        if current_record != 19:
            ...
            current_record = 0
    sheet = pe.Sheet(tdl)
    sheet.save_as("1920censusrecords.csv")
